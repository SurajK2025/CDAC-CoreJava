...
import OOP.Day4.EmpOrg.exception.EmpIdNotFoundException;
import OOP.Day4.EmpOrg.pojo.Employee;
import OOP.Day4.EmpOrg.pojo.Manager;
import OOP.Day4.EmpOrg.pojo.Worker;

public class TestOraganisation2 {

	public static void main(String[] args) throws EmpIdNotFoundException{
		...
		do {
			...
			case 4 :  
				...
				if(!empFound) {
					try {
					throw new EmpIdNotFoundException("Employee with "+temp+"ID not found or Invalid Empid");
					}
					catch(EmpIdNotFoundException e) {
						e.printStackTrace();
					}
				}					
					break;
