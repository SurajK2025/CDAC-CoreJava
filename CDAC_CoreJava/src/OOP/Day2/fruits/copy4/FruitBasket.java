...
public class FruitBasket {
	...
	public static void main(String[] args) {
		...
		//				switch (frt.getName()) {
		//				case "Apple":
		//					System.out.println(((Apple)frt).jam());
		//					break;
		//				case "Mango":
		//					System.out.println(((Mango)frt).pulp());
		//					break;
		//				case "Orange":
		//					System.out.println(((Orange)frt).juice());
		//					break;
		//				}
		//				break;
		//			}
		...
		for (Fruit frt : fruits) {
			if(count+1 == index){
				if(frt instanceof Apple)
					System.out.println(((Apple)frt).jam());
				else if(frt instanceof Apple)
					System.out.println(((Mango)frt).pulp());
				else
					System.out.println(((Orange)frt).juice());
				break;
